...
[![x-cmd/install — carvel-kapp Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/carvel-kapp.svg?lang=zh)](https://x-cmd.com/install/carvel-kapp)
...
- **Star**: 1,083 · **Fork**: 134 · **开放 issue**: 379 · **贡献者**: 81

## 累计统计

- **发布数**: 111 · **已合并 PR**: 451 · **开放 PR**: 19 · **已关闭 issue**: 270 · **开放 issue**: 109 · **提交数**: 1066
...
_数据快照: `data/card/260925.yml` · 2026-09-25T05:09:20Z._
